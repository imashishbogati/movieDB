...
//  UIView+Layout.swift
//
//  Created by Aashish Bogati on 4/7/20.
//  Copyright © 2020 Aashish Bogati. All rights reserved.
//

// Source : https://github.com/bhlvoong/LBTATools/blob/master/Source/AnchoredConstraints.swift

import UIKit
@available(iOS 9.0, tvOS 11.0, *)
public enum Anchor {
...
extension UIView {
    ...
    @discardableResult
    public func fillSuperViewWithSafeArea(padding : UIEdgeInsets = .zero) -> AnchoredConstraints {
        translatesAutoresizingMaskIntoConstraints = false
        let anchoredConstraints = AnchoredConstraints()
...
//    }
    ...
    public func centerInSuperview(size: CGSize = .zero, xConstant : CGFloat = .zero, yConstant : CGFloat = .zero) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    public func centerXToConstant(_ anchor: NSLayoutXAxisAnchor, constant: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    public func centerYToConstant(_ anchor: NSLayoutYAxisAnchor, constant: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
